...
$(package)_qtmultimedia_sha256_hash=04ceb3b310fac4d0f13903c01a84604dd4ff793398f2c9b20bc698b5deaf60e9
...
define $(package)_preprocess_cmds
  ...
  sed -i.old "s|updateqm.commands = \$$$$\$$$$LRELEASE|updateqm.commands = $($(package)_extract_dir)/qttools/bin/lrelease|" qtmultimedia/qtmultimedia.pro && \
  sed -i.old "/updateqm.depends =/d" qttranslations/translations/translations.pro && \
	sed -i.old "/updateqm.depends =/d" qtmultimedia/qtmultimedia.pro && \
...
define $(package)_config_cmds
	export PATH=$(host_prefix)/native/bin/:$(PATH) && \
...
define $(package)_stage_cmds
  ...
  $(MAKE) -C qtmultimedia INSTALL_ROOT=$($(package)_staging_dir) install_subtargets && \
